...
RSpec.describe V1::ScorecardReferencesController, type: :request do
  describe "POST #create" do
    ...
    context "success" do
      before {
        post "/api/v1/scorecards/#{scorecard.uuid}/scorecard_references", params: { scorecard_reference: params.to_json, attachment: Rack::Test::UploadedFile.new(fixture_image_path("reference_image.png")) }, headers: headers
      }
